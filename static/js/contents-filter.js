...
$(document).ready(function () {
  // Determine the number of blog and sample posts to display on a single page, depending on the resolution (device type)
  var pageOffset = 9;
  ...
  // Handle filtering operation on blog and sample posts
  var options = {
    valueNames: ["tag"],
    page: pageOffset,
    pagination: true
  ...
  $('.filter-box .btn-wrap button').on('click', function () {
