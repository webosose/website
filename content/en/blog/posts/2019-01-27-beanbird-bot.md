...
{{< figure src="https://github.com/lgsvl/build-ros2-lgsvl/wiki/image1.jpg" caption="Beanbird Bot" >}}
...
1.  You can find the instructions for assembling the basic Duckiebot configuration on the main Duckietown documentation site [here](http://docs.duckietown.org/DT18/opmanual_duckiebot/out/assembling_duckiebot_db18.html).
...
{{< figure src="https://github.com/lgsvl/build-ros2-lgsvl/wiki/image2.jpg" caption="Joystick controller used to control the robot" >}}

{{< figure src="https://github.com/lgsvl/build-ros2-lgsvl/wiki/image3.jpg" caption="Ultrasound and range sensor" >}}
...
{{< figure src="https://github.com/lgsvl/build-ros2-lgsvl/wiki/image4.jpg" caption="A fully assembled Beanbird Bot" >}}

## ROS 2 on webOS

{{< figure src="/images/blog/articles/beanbird-bot-yocto-layer.png" caption="The Yocto layer of Beanbird Bot" >}}
...
{{< figure src="https://github.com/lgsvl/build-ros2-lgsvl/wiki/image6.png" caption="Core system components driving Beanbird Bot" >}}
...
{{< figure src="https://github.com/lgsvl/build-ros2-lgsvl/wiki/image7.png" caption="The Face Application UI with touchscreen controls" >}}
...
{{< figure src="https://github.com/lgsvl/build-ros2-lgsvl/wiki/image8.png" caption="The web app enables dynamic facial expressions, animations, and features" >}}
...
{{< figure src="https://github.com/lgsvl/build-ros2-lgsvl/wiki/image9.jpg" caption="A lane-following Beanbird Bot" >}}
...
{{< figure src="https://github.com/lgsvl/build-ros2-lgsvl/wiki/image10.jpg" caption="Build one yourself!" >}}
